...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        if($jumlah >= $qtyskrg){
            ...
            if ($updatedata1 && $queryx){
                ...
                <meta http-equiv='refresh' content='1; url= keluarbar.php'/>  ";
                } else { echo "<div class='alert alert-warning'>
                    <strong>Failed!</strong> Redirecting you back in 3 seconds.
                </div>
                <meta http-equiv='refresh' content='3; url= keluarbar.php'/> ";
                };
    ...
    if(isset($_POST['hapus'])){
        ...
        $lihatstock = mysqli_query($conn,"select * from sstock_brg where idx='$idx'"); //lihat stock barang itu saat ini
        $stocknya = mysqli_fetch_array($lihatstock); //ambil datanya    te
        $stockskrg = $stocknya['stock'];//jumlah stocknya skrg
                        ...
                        <ul class="metismenu" id="menu">
							...
							<li class="active">
                                ...
                                <ul class="active">
                                    ...
                                    <li class="active"><a href="keluarbar.php">Barang Keluar</a></li>
                                </ul>
                            </li>
                            <li>
                                                ...
                                                <div class="modal fade" id="edit<?=$id;?>">
                                                    ...
                                                    <div class="modal fade" id="del<?=$id;?>">
                                                        ...
                                                        <form method="post">
                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                            <h4 class="modal-title">Hapus Barang <?php echo $b['nama']?> - <?php echo $b['jenis']?> - <?php echo $b['stock']?> </h4>
                                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            </div>
