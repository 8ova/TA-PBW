                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
							<li class="active"><a href="kitchen.php"><span>Notes</span></a></li>
                            <li>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                <li><a href="kitchen.php">Home</a></li>
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
										...
										<tr>
										 ...
										 <form method ='POST' action = 'notes1.php'>
										...
										$id = $data['id'];
										 echo "  <form method ='POST' action = 'done.php'>
										  ...
										  <td><center><input type = 'hidden' name = 'id' value = '".$data['id']."'> <input type='submit' name = 'submit'  class='btn btn-danger btn-sm' value = 'Delete' formaction='del1.php' /></center></td>
										  </form></td>
										  </tr> </form>
										  ";
										 $i++; 
