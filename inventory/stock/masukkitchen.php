                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
							...
							<li class="active">
                                ...
                                <ul class="active">
                                    <li class="active"><a href="masukkitchen.php">Barang Masuk / Kembali</a></li>
						...
						<div class="modal-body">
							<form action="barang_masuk_act.php" method="post">
								...
								<div class="form-group">
									...
									?>
										<option value="<?php echo $d['idx'] ?>"><?php echo $d['nama'] ?> <?php echo $d['jenis'] ?> <?php echo $d['merk'] ?>, Qty. <?php echo $d['stock'] ?></option>
										<?php
								}
								?>
									</select>
