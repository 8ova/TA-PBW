...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update sstock_brg set nama='$nama', divisi='$divisi', berat='$berat', jenis='$jenis', merk='$merk',  satuan='$satuan', lokasi='$lokasi' where idx='$idx'");
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                    <a href="kitchen.php"><img src="../logo.png" alt="logo" width="100%"></a>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
							<li><a href="noteskitchen.php"><span>Notes</span></a></li>
                            <li class="active">
                                <a href="kitchen.php"><i class="ti-dashboard"></i><span>Stock Barang</span></a>
                            </li>
							<li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-layout"></i><span>Transaksi Data
                                    </span></a>
                                <ul class="collapse">
                                    <li><a href="masukkitchen.php">Barang Masuk / Kembali</a></li>
                                    <li><a href="keluarkitchen.php">Barang Keluar</a></li>
                                </ul>
                            </li>
                            <li>
                                                ...
                                                <!-- The Modal -->
                                                    <div class="modal fade" id="edit<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <label for="jenis">Divisi</label>
                                                            <input type="text" id="divisi" name="divisi" class="form-control" value="<?php echo $p['divisi'] ?>">

                                                            <label for="berat">Berat</label>
                                                            <input type="text" id="berat" name="berat" class="form-control" value="<?php echo $p['berat'] ?>">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="tmb_brg_act.php" method="post">
								...
								<div class="form-group">
									<label>Divisi</label>
									<select name="divisi" class="custom-select form-control">
                                ...
                                <div class="form-group">
									<label>Berat</label>
									<input name="berat" type="text" class="form-control" placeholder="Merk Barang">
								</div>
                                <div class="form-group">
									<label>Jenis</label>
									<input name="jenis" type="text" class="form-control" placeholder="Merk Barang">
								</div>
								<div class="form-group">
									<label>Merk</label>
