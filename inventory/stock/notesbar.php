                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
							<li class="active"><a href="bar.php"><span>Notes</span></a></li>
                            <li>
                                    ...
                                    <div class="table-responsive">
										...
										$id = $data['id'];
										 echo "  <form method ='POST' action = 'done.php'>
										  ...
										  <td><center><input type = 'hidden' name = 'id' value = '".$data['id']."'> <input type='submit' name = 'submit'  class='btn btn-danger btn-sm' value = 'Delete' formaction='del2.php' /></center></td>
										  </form></td>
										  </tr> </form>
										  ";
										 $i++; 
